...
export const PLANS: PlanConfig[] = [
  {
    ...
    maxActiveGigs: 3,
    maxActiveBarterRequests: 3,
    monthlyBarterMatchCredits: 5,
    maxActiveProjects: 3,
    portfolioSlots: 3,
  ...
  },
  {
    ...
    maxActiveGigs: 8,
    maxActiveBarterRequests: 8,
    monthlyBarterMatchCredits: 20,
    maxActiveProjects: 8,
    portfolioSlots: 8,
  ...
  },
  {
    ...
    maxActiveGigs: 20,
    maxActiveBarterRequests: 20,
    monthlyBarterMatchCredits: 100,
